      ...
      <section className="pt-36 pb-16 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-bold tracking-tight mb-6">{tm.title}</h1>
            <p className="text-dim text-xl max-w-2xl mx-auto leading-relaxed">{tm.subtitle}</p>
            <p className="text-mute text-sm mt-4">{tm.lastUpdated}</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="pb-32 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <a
              href="mailto:legal@sentrak.info"
